    ...
    CommandLineRunner localServerStart(MemberRepository memberRepository,
        ...
        return args -> {
            ...
            seatCommandRepository.saveAll(Arrays.asList(
                    newSeat(1, "A1", "1", 19999, LocalDateTime.of(2024, 10, 22, 19, 15), concert01, SeatStatus.AVAILABLE),
                    newSeat(1, "A2", "2", 19999, LocalDateTime.of(2024, 10, 22, 19, 30), concert01, SeatStatus.AVAILABLE),
                    newSeat(1, "A3", "3", 19999, LocalDateTime.of(2024, 10, 22, 19, 45), concert01, SeatStatus.AVAILABLE),
                    newSeat(1, "A4", "4", 19999, LocalDateTime.of(2024, 10, 22, 20, 0), concert01, SeatStatus.AVAILABLE),
                    newSeat(1, "A5", "5", 19999, LocalDateTime.of(2024, 10, 22, 20, 15), concert01, SeatStatus.AVAILABLE),

                    newSeat(1, "B1", "6", 19999, LocalDateTime.of(2024, 10, 22, 20, 30), concert01, SeatStatus.AVAILABLE),
                    newSeat(1, "B2", "7", 19999, LocalDateTime.of(2024, 10, 22, 20, 45), concert01, SeatStatus.AVAILABLE),
                    newSeat(1, "B3", "8", 19999, LocalDateTime.of(2024, 10, 22, 21, 0), concert01, SeatStatus.AVAILABLE),
                    newSeat(1, "B4", "9", 19999, LocalDateTime.of(2024, 10, 22, 21, 15), concert01, SeatStatus.AVAILABLE),
                    newSeat(1, "B5", "10", 19999, LocalDateTime.of(2024, 10, 22, 21, 30), concert01, SeatStatus.AVAILABLE),
                    ...
                    newSeat(1, "D3", "18", 19999, LocalDateTime.of(2024, 10, 22, 23, 30), concert01, SeatStatus.AVAILABLE),
                    newSeat(1, "D4", "19", 19999, LocalDateTime.of(2024, 10, 22, 23, 45), concert01, SeatStatus.AVAILABLE),
                    newSeat(1, "D5", "20", 19999, LocalDateTime.of(2024, 10, 23, 0, 0), concert01, SeatStatus.AVAILABLE),

                    newSeat(1, "E1", "21", 19999, LocalDateTime.of(2024, 10, 23, 0, 30), concert01, SeatStatus.AVAILABLE),
                    newSeat(1, "E2", "22", 19999, LocalDateTime.of(2024, 10, 23, 0, 45), concert01, SeatStatus.AVAILABLE),
                    newSeat(1, "E3", "23", 19999, LocalDateTime.of(2024, 10, 23, 1, 0), concert01, SeatStatus.AVAILABLE),
                    newSeat(1, "E4", "24", 19999, LocalDateTime.of(2024, 10, 23, 1, 15), concert01, SeatStatus.AVAILABLE),
                    newSeat(1, "E5", "25", 19999, LocalDateTime.of(2024, 10, 23, 1, 30), concert01, SeatStatus.AVAILABLE),
                    newSeat(1, "E6", "26", 19999, LocalDateTime.of(2024, 10, 23, 1, 45), concert01, SeatStatus.AVAILABLE),

                    newSeat(1, "F1", "27", 19999, LocalDateTime.of(2024, 10, 23, 2, 0), concert01, SeatStatus.AVAILABLE),
                    newSeat(1, "F2", "28", 19999, LocalDateTime.of(2024, 10, 23, 2, 15), concert01, SeatStatus.AVAILABLE),
                    newSeat(1, "F3", "29", 19999, LocalDateTime.of(2024, 10, 23, 2, 30), concert01, SeatStatus.RESERVED),
                    newSeat(1, "F4", "30", 19999, LocalDateTime.of(2024, 10, 23, 2, 45), concert01, SeatStatus.AVAILABLE),
                    newSeat(1, "F5", "31", 19999, LocalDateTime.of(2024, 10, 23, 3, 0), concert01, SeatStatus.AVAILABLE),
                    newSeat(1, "F6", "32", 19999, LocalDateTime.of(2024, 10, 23, 3, 15), concert01, SeatStatus.AVAILABLE),

                    newSeat(1, "G1", "33", 19999, LocalDateTime.of(2024, 10, 23, 3, 30), concert01, SeatStatus.AVAILABLE),
                    newSeat(1, "G2", "34", 19999, LocalDateTime.of(2024, 10, 23, 3, 45), concert01, SeatStatus.AVAILABLE),
                    newSeat(1, "G3", "35", 19999, LocalDateTime.of(2024, 10, 23, 4, 0), concert01, SeatStatus.AVAILABLE),
                    newSeat(1, "G4", "36", 19999, LocalDateTime.of(2024, 10, 23, 4, 15), concert01, SeatStatus.AVAILABLE),
                    newSeat(1, "G5", "37", 19999, LocalDateTime.of(2024, 10, 23, 4, 30), concert01, SeatStatus.AVAILABLE),
                    newSeat(1, "G6", "38", 19999, LocalDateTime.of(2024, 10, 23, 4, 45), concert01, SeatStatus.AVAILABLE),

                    newSeat(1, "H1", "39", 19999, LocalDateTime.of(2024, 10, 23, 5, 0), concert01, SeatStatus.AVAILABLE),
                    newSeat(1, "H2", "40", 19999, LocalDateTime.of(2024, 10, 23, 5, 15), concert01, SeatStatus.AVAILABLE),
                    newSeat(1, "H3", "41", 19999, LocalDateTime.of(2024, 10, 23, 5, 30), concert01, SeatStatus.AVAILABLE),
                    newSeat(1, "H4", "42", 19999, LocalDateTime.of(2024, 10, 23, 5, 45), concert01, SeatStatus.AVAILABLE),
                    newSeat(1, "H5", "43", 19999, LocalDateTime.of(2024, 10, 23, 6, 0), concert01, SeatStatus.AVAILABLE),
                    newSeat(1, "H6", "44", 19999, LocalDateTime.of(2024, 10, 23, 6, 15), concert01, SeatStatus.AVAILABLE),

                    newSeat(1, "I1", "45", 19999, LocalDateTime.of(2024, 10, 23, 6, 45), concert01, SeatStatus.AVAILABLE),
                    newSeat(1, "I2", "46", 19999, LocalDateTime.of(2024, 10, 23, 7, 0), concert01, SeatStatus.AVAILABLE),
                    newSeat(1, "I3", "47", 19999, LocalDateTime.of(2024, 10, 23, 7, 15), concert01, SeatStatus.AVAILABLE),
                    newSeat(1, "I4", "48", 19999, LocalDateTime.of(2024, 10, 23, 7, 30), concert01, SeatStatus.AVAILABLE),
                    newSeat(1, "I5", "49", 19999, LocalDateTime.of(2024, 10, 23, 7, 45), concert01, SeatStatus.AVAILABLE),
                    newSeat(1, "I6", "50", 19999, LocalDateTime.of(2024, 10, 23, 8, 0), concert01, SeatStatus.AVAILABLE),
                    newSeat(1, "I7", "51", 19999, LocalDateTime.of(2024, 10, 23, 8, 15), concert01, SeatStatus.AVAILABLE),

                    newSeat(1, "J1", "52", 19999, LocalDateTime.of(2024, 10, 23, 6, 45), concert01, SeatStatus.AVAILABLE),
                    newSeat(1, "J2", "53", 19999, LocalDateTime.of(2024, 10, 23, 7, 0), concert01, SeatStatus.AVAILABLE),
                    newSeat(1, "J3", "54", 19999, LocalDateTime.of(2024, 10, 23, 7, 15), concert01, SeatStatus.AVAILABLE),
                    newSeat(1, "J4", "55", 19999, LocalDateTime.of(2024, 10, 23, 7, 30), concert01, SeatStatus.AVAILABLE),
                    newSeat(1, "J5", "56", 19999, LocalDateTime.of(2024, 10, 23, 7, 45), concert01, SeatStatus.AVAILABLE),
                    newSeat(1, "J6", "57", 19999, LocalDateTime.of(2024, 10, 23, 8, 0), concert01, SeatStatus.AVAILABLE),
                    newSeat(1, "J7", "58", 19999, LocalDateTime.of(2024, 10, 23, 8, 15), concert01, SeatStatus.AVAILABLE),

                    newSeat(1, "K1", "59", 19999, LocalDateTime.of(2024, 10, 23, 6, 45), concert01, SeatStatus.AVAILABLE),
                    newSeat(1, "K2", "60", 19999, LocalDateTime.of(2024, 10, 23, 7, 0), concert01, SeatStatus.AVAILABLE),
                    newSeat(1, "K3", "61", 19999, LocalDateTime.of(2024, 10, 23, 7, 15), concert01, SeatStatus.AVAILABLE),
                    newSeat(1, "K4", "62", 19999, LocalDateTime.of(2024, 10, 23, 7, 30), concert01, SeatStatus.AVAILABLE),
                    newSeat(1, "K5", "63", 19999, LocalDateTime.of(2024, 10, 23, 7, 45), concert01, SeatStatus.AVAILABLE),
                    newSeat(1, "K6", "64", 19999, LocalDateTime.of(2024, 10, 23, 8, 0), concert01, SeatStatus.AVAILABLE),
                    newSeat(1, "K7", "65", 19999, LocalDateTime.of(2024, 10, 23, 8, 15), concert01, SeatStatus.AVAILABLE)
            ));
